...
export default function ReferralPage() {
  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-700 text-black">
      ...
      {/* Hero Section */}
      <Card className="rounded-[12px] border-neutral-200 shadow-none bg-neutral-950 text-white overflow-hidden relative">
        <CardContent className="p-8 md:p-12 relative z-10">
          <div className="max-w-2xl space-y-6">
            ...
            <p className="text-neutral-300 text-sm font-light leading-relaxed">
              Invite your friends to experience our premium collection. They get <span className="text-white font-bold">PKR 500 off</span> their first order, and you earn <span className="text-white font-bold">50 loyalty points</span> for every successful referral.
            </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          { label: 'Total Referred', value: '12', icon: Users },
          { label: 'Points Earned', value: '600', icon: Award },
          { label: 'Pending Credits', value: 'PKR 1,500', icon: Gift },
        ].map((stat, i) => (
          <div key={i} className="p-8 border border-neutral-200 space-y-4 rounded-[12px] bg-white shadow-sm hover:border-black transition-all group">
      ...
      <div className="space-y-6 pt-8 border-t border-neutral-200">
        ...
        <div className="flex flex-wrap gap-4">
          <Button variant="outline" className="rounded-[12px] h-12 px-6 border-neutral-300 text-black hover:bg-black hover:text-white text-[10px] uppercase tracking-widest font-bold flex items-center gap-2 transition-all shadow-sm">
            WhatsApp
          </Button>
          <Button variant="outline" className="rounded-[12px] h-12 px-6 border-neutral-300 text-black hover:bg-black hover:text-white text-[10px] uppercase tracking-widest font-bold flex items-center gap-2 transition-all shadow-sm">
            Instagram
