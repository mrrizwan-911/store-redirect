  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-8 pt-10 pb-20">
      <div className="bg-black text-white -mx-6 md:-mx-8 px-6 md:px-8 py-12 mb-12">
        <Skeleton className="h-4 w-32 bg-white/10 mb-4 rounded-none" />
        <Skeleton className="h-16 w-1/2 bg-white/10 rounded-none" />
      </div>

      <div className="flex items-center gap-3 mb-8">
        <Skeleton className="h-4 w-24 bg-neutral-100 rounded-none" />
        ...
        {Array.from({ length: 8 }).map((_, i) => (
          <div key={i} className="space-y-4">
            ...
            <div className="flex justify-between">
              ...
              <Skeleton className="h-4 w-1/4 bg-neutral-50 rounded-none" />
            </div>
