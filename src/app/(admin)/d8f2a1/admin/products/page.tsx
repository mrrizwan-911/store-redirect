        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-[#E5E5E5] bg-white">
              ...
              <th className="p-4 text-sm font-medium text-[#737373]">Stock</th>
          ...
          <tbody>
            {products.map((product) => {
              ...
              return (
                <tr
                  key={product.id}
                  className="border-b border-[#E5E5E5] hover:border-l-2 hover:border-l-[#E8D5B0] transition-all bg-white"
                >
