...
export function LookbookTeaser() {
  ...
  return (
    <section className="bg-black py-20 md:py-32 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">

          {/* ── Abstract Editorial Images Grid ──
              On mobile (grid-cols-1) the absolute-positioned images were escaping
              their container. We give the wrapper an explicit mobile height
              and use relative+overflow-hidden to clip them properly. */}
          <div className="relative h-[420px] sm:h-[500px] md:h-[650px] lg:h-[750px] overflow-hidden">
            ...
            <div className="absolute left-[20%] top-[18%] w-1/2 aspect-[3/4] z-20 group overflow-hidden border border-white/10 shadow-2xl">
              <Image
                src={lookbook2}
            ...
            <div className="absolute right-0 bottom-0 w-[45%] aspect-[3/4] z-30 group overflow-hidden border border-white/10 shadow-2xl grayscale hover:grayscale-0 transition-all duration-1000">
              <Image
                src={lookbook3}
          ...
          <div className="max-w-xl">
            <span className="text-[10px] uppercase tracking-[0.6em] text-white/40 font-bold mb-6 sm:mb-8 block">
              Editorial Vol. 01 — Style Guide
            </span>
            <h2 className="font-display text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-medium leading-[0.85] mb-8 sm:mb-10 uppercase tracking-tighter">
              Complete the <br />
              <span className="italic font-light opacity-80">Luxury</span> Look
            </h2>
            <p className="text-white/50 text-base md:text-lg font-light leading-relaxed mb-10 sm:mb-12 max-w-lg font-sans">
            ...
            <Link
              href="/lookbook"
              className="inline-flex h-14 sm:h-16 items-center justify-center px-10 sm:px-12 bg-white text-black text-[10px] font-bold uppercase tracking-[0.3em] transition-all hover:bg-black hover:text-white hover:border hover:border-white group"
            >
              Browse Lookbook
              <ArrowRight className="ml-3 w-4 h-4 transition-transform group-hover:translate-x-1" />
            </Link>

            <div className="mt-16 sm:mt-24 flex gap-8 sm:gap-12 border-t border-white/10 pt-10 sm:pt-12">
