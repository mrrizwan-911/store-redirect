...
export function orderProcessingTemplate(name: string, orderNumber: string, items: OrderItem[], total: any): { subject: string; html: string; text: string } {
...
Your order #${orderNumber} is now being processed. We are carefully preparing your items for shipment.
    ...
    <tr><td align="center" style="padding:40px 20px;">
      <table width="520" style="background:#141414;border:1px solid #222;max-width:520px;width:100%;">
        <tr><td style="padding:32px;">
          <h2 style="color:#E8D5B0;font-size:22px;margin:0 0 8px;">Order Processing</h2>
          <p style="color:#888;font-size:14px;margin:0 0 24px;">Hi ${name}, we are now preparing your order #${orderNumber} for shipment. We'll notify you as soon as it ships.</p>
